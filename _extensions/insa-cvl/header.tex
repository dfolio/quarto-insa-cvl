...
\newtheoremstyle{remark} % name
    ...
    {}  % Theorem head spec (can be left empty, meaning ‘normal’)
% sol  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newenvironment{sol}{\smaller\color{DarkGreen}{}}
...
\raggedchapter
\interlinepenalty\@M
\parbox{\dimexpr\linewidth-2\fboxrule-2\fboxsep}{\raggedchapter{#2~\textcolor{chapterbarcolor}{\rule[-0.5em]{4pt}{1.75em}}~#3}}%
%\par\vskip-0.5em plus0.25em
%\textcolor{chapterbarcolor!80}{\rule{\linewidth}{2pt}}%
%\par\nobreak
}
}{}
\@ifclassloaded{scrbook}{
